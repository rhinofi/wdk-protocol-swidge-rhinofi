...
WDK module to perform cross-chain swaps via the rhinofi protocol.

## Installation

```bash
npm install @rhino.fi/wdk-protocol-swidge-rhinofi
```
...
const swidgeProtocol = new RhinofiProtocol()
